     ...
     return <Card>
         <form className= {classes.form} onSubmit={submitHandler}>
                ...
                <div className = {classes.control }>
                    ...
                    <input type="text" required id="Zanr" ref = {zanrInputRef}/> 
                </div>
                <div className = {classes.control }>
                    <label htmlFor='title'>BrojIzvodjenja</label>
                    <input type="text" required id="Broj izvodjenja" ref = {brojIzvodjenjaInputRef}/> 
                </div>
                <div className = {classes.control}>
                    <label htmlFor='title'>Premijera</label>
                    <input type="date" required id="datum premijere" ref = {premijeraInputRef}/> 
                </div>
